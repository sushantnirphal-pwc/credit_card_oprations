...
public class CardServiceImpl implements CardService {
    ...
    public CardResponseDTO issueCard(CardRequestDTO requestDTO) {
        ...
        Boolean exists = (customerExistsResponse != null) ? customerExistsResponse.getData() : null;
        boolean ok = customerExistsResponse != null && customerExistsResponse.isSuccess()
                && exists != null && exists.booleanValue();
    ...
    public CardResponseDTO getCardByCardNumber(String cardNumber) {
        log.info("Fetching card with card number: {}", maskCardNumber(cardNumber));

        Card card = cardRepository.findByCardNumber(cardNumber)
                .orElseThrow(() -> new CardNotFoundException("Card not found with number: " + maskCardNumber(cardNumber)));
    ...
    public CardResponseDTO updateCardBalance(Long cardId, Double amount, Boolean isDebit) {
        ...
        if (Boolean.TRUE.equals(isDebit)) {
