...
public class CustomerRequestDTO {
    ...
    public CustomerRequestDTO(String firstName, String lastName, String email, String phone, String address, String city, String state, String zipCode, LocalDateTime dateOfBirth) {
        this.firstName = firstName;
        this.lastName = lastName;
        this.email = email;
        this.phone = phone;
    ...
    public static class Builder {
        ...
        public CustomerRequestDTO build() {
            CustomerRequestDTO obj = new CustomerRequestDTO();
